...
####pip install ipython #if ipython is not installed
...
/projects/psg/people/gnr216/a-software/feems/feems/data
...
# setup graph
coord = np.loadtxt("{}/Autosomes_onlyEurasianwolves_filtered_noindels_noastrick_diploid_minQ30_biallelic_maxmiss0.9_LDprune_final.coord".format("./"))  # sample coordinates
outer = np.loadtxt("{}/Autosomes_onlyEurasianwolves_filtered_noindels_noastrick_diploid_minQ30_biallelic_maxmiss0.9_LDprune_final.outer".format("./"))  # outer coordinates
...
/projects/mjolnir1/people/crq857/Chapter2/03_GeneflowAnalyses/FEEMS/finaldataset/res.eurasia_samples_Sept11.pdf

scp -r crq857@mjolnirgate.unicph.domain:/projects/mjolnir1/people/crq857/Chapter2/03_GeneflowAnalyses/FEEMS/finaldataset/res.eurasia.cv.pdf ~/Desktop



Extract command lines
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cd /projects/psg/people/crq857/Chapter2/03_GeneflowAnalyses/FEEMS/finaldataset
screen
srun -N 1 -c 1 --mem-per-cpu=64g -t 1-0:0:0 --pty bash -i
