...
snpeff_lof <- read.delim("load_LOF_final.txt")
snpeff_missense <- read.delim("load_missense_final.txt") #missense
snpeff_syn <- read.delim("load_synonymous_variant_final.txt")
snpeff_mod <- read.delim("load_Modifier_final_1_1million.txt")
snpeff_mod <- read.delim("load_Modifier_final_1million_2million_header.txt")
snpeff_mod <- read.delim("load_Modifier_final_2million_3million_header.txt")
snpeff_mod <- read.delim("load_Modifier_final_3million_4million_header.txt")
snpeff_mod <- read.delim("load_Modifier_final_4million_5million_header.txt")
snpeff_mod <- read.delim("load_Modifier_final_5million_6million_header.txt")
