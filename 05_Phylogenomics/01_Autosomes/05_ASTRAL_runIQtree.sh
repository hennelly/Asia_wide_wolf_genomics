...
#ls  *phy > FINAL_list_autosomes_noadmix.txt_phy_noEthmore.txt

### no dogs, with NA
PHY=$(sed "${SLURM_ARRAY_TASK_ID}q;d" /projects/mjolnir1/people/crq857/Chapter2/05_Phylogenomics/x_FINAL_July262024_input_autosomes_nodogswithNA_noEth_more/FINAL_list_autosomes_noadmix.txt_phy_noEthmore.txt)

/home/crq857/bin/iqtree-1.6.12-Linux/bin/iqtree -s  /projects/mjolnir1/people/crq857/Chapter2/05_Phylogenomics/x_FINAL_July262024_input_autosomes_nodogswithNA_noEth_more/${PHY} -bb 1000 -nt AUTO
