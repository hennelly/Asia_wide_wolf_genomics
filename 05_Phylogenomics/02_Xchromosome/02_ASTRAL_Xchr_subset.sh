...
bedtools intersect -a ${VCF} -b /projects/mjolnir1/people/crq857/Chapter2/05_Phylogenomics/bedfiles_chrX/${BEDFILE} > ${DIR}/Final_July26_ChrX_allwolves_March2024_chrX_${BEDFILE}_allexceptdogs_withNA_NO_ETHIOPIAN.vcf
...
DIR_noadmix=/projects/mjolnir1/people/crq857/Chapter2/05_Phylogenomics/xFINAL_chrX_July262026_input_July2024_noadmix_noEth

#No admix and dogs 
bedtools intersect -a ${VCF_noadmix} -b /projects/mjolnir1/people/crq857/Chapter2/05_Phylogenomics/bedfiles_chrX/${BEDFILE} > ${DIR_noadmix}/Final_July26_ChrX_allwolves_March2024_chrX_${BEDFILE}_noadmixwolves_NOETHIOPIAN.vcf
